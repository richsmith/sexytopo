    ...
    public void setMode(Mode mode) {
        ...
        switch (mode) {
            case NULL:
                ...
                break;
            case MEASUREMENT:
                requestedProtocol = new MeasurementProtocol(context, bluetoothDevice, dataManager);
                break;
            case CALIBRATION:
                requestedProtocol = new CalibrationProtocol(context, bluetoothDevice, dataManager);
                break;
            default:
