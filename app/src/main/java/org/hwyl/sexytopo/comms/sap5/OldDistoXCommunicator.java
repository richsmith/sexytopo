    ...
    public void setProtocol(Protocol protocol) {
        ...
        switch (protocol) {
            case NULL:
                ...
                break;
            case MEASUREMENT:
                requestedProtocol = new MeasurementProtocol(activity, bluetoothDevice, dataManager);
                break;
            case CALIBRATION:
                requestedProtocol = new CalibrationProtocol(activity, bluetoothDevice, dataManager);
                break;
            default:
