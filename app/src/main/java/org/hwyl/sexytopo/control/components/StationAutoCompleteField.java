...
public class StationAutoCompleteField {
    ...
    public StationAutoCompleteField(Context context, Survey survey, String hint) {
        ...
        String[] stationNames =
                survey.getAllStations().stream().map(Station::getName).toArray(String[]::new);
    ...
    /**
     * Get the TextInputLayout containing the autocomplete field. This should be added to your
     * dialog or view.
     */
    ...
    /**
     * Enable validation that disables a button when no valid station is selected. Call this after
     * the dialog is shown so the button exists.
     *
