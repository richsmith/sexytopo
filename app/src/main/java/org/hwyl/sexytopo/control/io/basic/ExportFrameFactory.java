...
public class ExportFrameFactory {
    ...
    public static Frame getExportFrame(Survey survey, Projection2D projectionType) {
        ...
        // Basic bounds are the union of the sketch and the survey data. The sketch's own bounding
        // box already accounts for anything drawn at other than its natural size, such as a
        // cross-section drawn at other than the default scale (see
        // CrossSectionDetail.refreshBoundingBox), so there is nothing further to do here for that.
