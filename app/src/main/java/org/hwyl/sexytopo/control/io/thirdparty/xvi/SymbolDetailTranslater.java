...
public class SymbolDetailTranslater extends SketchDetailTranslater<SymbolDetail> {
    ...
    static {
        ...
        XVI_PATH_DATA.put(
                ...
                new float[][] {
                    {
                        8.84876f, 9.42738f, 27.58284f, 10.27319f, 12.06031f, 23.80615f, 8.84876f,
                        9.42738f
                    },
                    {
                        26.69074f, 17.88548f, 31.15124f, 19.57709f, 27.58284f, 30.57262f, 13.30926f,
                        30.57262f, 26.69074f, 17.88548f
                    },
                    {8.84876f, 9.42738f, 13.30926f, 13.65643f, 12.06031f, 23.80615f},
                    {13.30926f, 13.65643f, 27.58284f, 10.27319f},
                    {
                        26.69074f, 17.88548f, 27.58284f, 20.42291f, 25.49501f, 23.23703f, 13.30926f,
                        30.57262f
                    },
        ...
        XVI_PATH_DATA.put(
                ...
                new float[][] {
                    ...
                    {
                        19.95307f, 15.89207f, 19.95307f, 20.89207f, 19.95307f, 20.89207f, 13.19741f,
                                25.89207f,
                        13.19741f, 25.89207f, 19.95307f, 30.89207f, 19.95307f, 30.89207f, 19.95307f,
                                35.89207f
                    } // Bottom wavy
                });
        ...
        XVI_PATH_DATA.put(
                ...
                new float[][] {
                    ...
                    {
                        19.64792f, 34.47846f, 21, 30, 22, 26, 22, 24, 20, 20, 18, 16, 18, 12,
                        19.75f, 9.77f
                    },
                    // Arrow head
                    {
                        16.62578f, 9.7767f, 19.75460f, 4.99145f, 19.75460f, 4.99145f, 22.88342f,
                        9.7767f, 22.88342f, 9.7767f, 16.62578f, 9.7767f
                    }
                });
        ...
        XVI_PATH_DATA.put(
                ...
                new float[][] {
                    {
                        19.75f, 9.77f, 19.71098f, 29.7324f
                    }, // Main vertical line - starts at arrow base
                    // Arrow head
                    {
                        16.62578f, 9.7767f, 19.75460f, 4.99145f, 19.75460f, 4.99145f, 22.88342f,
                        9.7767f, 22.88342f, 9.7767f, 16.62578f, 9.7767f
