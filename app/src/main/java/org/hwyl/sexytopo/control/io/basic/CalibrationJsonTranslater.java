...
public class CalibrationJsonTranslater {
    ...
    public static String toText(List<CalibrationReading> calibrationReadings) throws JSONException {
        return toJson(calibrationReadings).toString(SexyTopoConstants.JSON_INDENT);
    }

    public static List<CalibrationReading> toCalibrationReadings(String string)
